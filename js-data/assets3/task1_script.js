(() => {
    ...
    const dropitems = document.querySelectorAll('.task1_dropeitem')
    ...
    const answers = [{
            id: 1,
            data: '2',
            src: 'Images_4/assets3/task1_1.png'
        },
        {
            id: 2,
            data: '1',
            src: 'Images_4/assets3/task1_2.png'

        },
        {
            id: 3,
            data: '4',
            src: 'Images_4/assets3/task1_3.png'

        },
        {
            id: 4,
            data: '3',
            src: 'Images_4/assets3/task1_4.png'
    ...
    document.addEventListener('mouseup', (e) => {
        if (draggingItem) {
            ...
            elemBelow = elemBelow.closest(".task1_dropeitem")

            if (elemBelow && elemBelow.classList.contains("task1_dropeitem") && elemBelow.children.length < 3) {
