(() => {
    ...
    const dropitems = document.querySelectorAll('.task2_dropeitem')
    ...
    const answers = [{
            id: 1,
            data: '2',
            src: 'Images_4/assets1/task2_1.png'
        },
        {
            id: 2,
            data: '1',
            src: 'Images_4/assets1/task2_2.png'

        },
        {
            id: 3,
            data: '1',
            src: 'Images_4/assets1/task2_3.png'

        },
        {
            id: 4,
            data: '2',
            src: 'Images_4/assets1/task2_4.png'
    ...
    document.addEventListener('mouseup', (e) => {
        if (draggingItem) {
            ...
            elemBelow = elemBelow.closest(".task2_dropeitem")

            if (elemBelow && elemBelow.classList.contains("task2_dropeitem") && elemBelow.children.length < 3) {
