(() => {
    ...
    const answers = [{
            id: 1,
            src: 'Images_4/assets5/task11_1.png',
            height: '60px',
            width: '100px'
        },
        {
            id: 2,
            src: 'Images_4/assets5/task11_2.png',
            height: '100px',
            width: '100px'
        ...
        {
            id: 3,
            src: 'Images_4/assets5/task11_3.png',
            height: '60px',
            width: '150px'
        },
        {
            id: 4,
            src: 'Images_4/assets5/task11_4.png',
            height: '60px',
            width: '100px'
        },
        {
            id: 5,
            src: 'Images_4/assets5/task11_5.png',
            height: '60px',
            width: '100px'
        },
        {
            id: 6,
            src: 'Images_4/assets5/task11_6.png',
            height: '150px',
            width: '50px'
        },
        {
            id: 7,
            src: 'Images_4/assets5/task11_7.png',
            height: '60px',
            width: '100px'
