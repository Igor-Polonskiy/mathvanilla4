(() => {
    ...
    const drops = document.querySelectorAll('.task9_imgWrapper_img')
    ...
    const answers = [{
            id: 3,
            data: 'Images_4/assets6/task9_6.png'
        },
        {
            id: 2,
            data: 'Images_4/assets6/task9_5.png'
        },
        {
            id: 1,
            data: 'Images_4/assets6/task9_4.png'
        }
    ]
    ...
    function setAnswers() {
        answers.sort(() => Math.random() - 0.5).forEach(item => {
            ...
            answer.classList.add(`task9_img1${item.id}`)
    ...
    document.addEventListener('mouseup', (e) => {
        if (draggingItem) {
            ...
            if (elemBelow.classList.contains("task9_imgWrapper_img") && elemBelow.children.length === 0) {
